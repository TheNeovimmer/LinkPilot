...
export const messages: Messages = {
  ...
  'dashboard.quick.logApp': 'Log application',
  'dashboard.quick.addJob': 'Add job',
  'dashboard.quick.schedule': 'Schedule interview',
  'dashboard.quick.newConv': 'New conversation',
  'dashboard.attention.title': 'Needs attention',
  'dashboard.attention.empty': 'All clear. Nothing stale or overdue.',
  'dashboard.attention.staleApp': '{role} at {company} · {n}d no reply',
  'dashboard.attention.staleRec': '{name} · no contact {date}',
  'dashboard.attention.overdue': '{title} · overdue {date}',
  'dashboard.momentum.title': 'This week',
  'dashboard.momentum.apps': 'Applications',
  'dashboard.momentum.interviews': 'Interviews next 7d',
  'dashboard.momentum.messages': 'Messages',
  'dashboard.recentApps': 'Recent applications',
  'dashboard.topJobs': 'Top fit jobs',
  'dashboard.topJobs.empty': 'Analyze jobs to see fit scores here.',
  'dashboard.recruiterFollow': 'Recruiter follow-ups',
