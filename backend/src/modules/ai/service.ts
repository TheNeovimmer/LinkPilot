...
import { buildDraftMessages, buildRewriteMessages } from '../../prompts/draftReply.js';
import { buildAnalyzeJobMessages, jobAnalysisSchema, type JobAnalysis } from '../../prompts/analyzeJob.js';
import { buildInterviewPrepMessages, interviewPrepSchema, type InterviewPrep } from '../../prompts/interviewPrep.js';
import { buildSummaryMessages, conversationSummarySchema, type ConversationSummary } from '../../prompts/summarize.js';
import type { ProfileContext } from '../../prompts/system.js';
import type { DraftHistoryItem } from '../../prompts/draftReply.js';
import type { AiDraftResult } from './types.js';
