    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex-row items-center justify-between">
            ...
            <Link to="/interviews" className="flex items-center gap-0.5 text-[12px] text-accent transition-colors hover:text-accent-strong">
            ...
            {isLoading ? (
              ...
              <div className="divide-y divide-border/60">
                {stats.interviews.upcoming.map((i) => (
                  <Link key={i.id} to={`/interviews/${i.id}`} className="flex items-center gap-3 py-2.5 first:pt-0 last:pb-0">
              ...
              <EmptyState
                ...
                action={
                  <Link to="/interviews?new=1" className="text-[12.5px] text-accent hover:underline">
        ...
        <Card>
          <CardHeader className="flex-row items-center justify-between">
            ...
            <Link to="/conversations" className="flex items-center gap-0.5 text-[12px] text-accent transition-colors hover:text-accent-strong">
              All <ArrowUpRight className="h-3 w-3" strokeWidth={1.75} />
            </Link>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              ...
              <EmptyState
                ...
                action={
                  <Link to="/conversations?new=1" className="text-[12.5px] text-accent hover:underline">
                    Start one
                  </Link>
                }
              />
      ...
      <Card>
        <CardHeader className="flex-row items-center justify-between">
          ...
          <Link to="/jobs" className="flex items-center gap-0.5 text-[12px] text-accent transition-colors hover:text-accent-strong">
      ...
      {stats && stats.reminders.overdue + stats.reminders.dueNext48h > 0 ? (
        <div className="flex items-center gap-3 rounded-[var(--radius-card)] border border-warning/30 bg-warning-muted px-4 py-3">
          ...
          <Link to="/reminders" className="ml-auto shrink-0 text-[12.5px] text-warning hover:underline">
            View reminders
          </Link>
        </div>
      ) : null}
